...
max_vector=Vector(0,0) # определение вектора с минимальной координатой
i=0
for next_vector in Vectors:
   if next_vector>max_vector:
    max_vector=next_vector


print("Максимум :", max_vector.x, max_vector.y)
